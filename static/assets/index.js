...
function get12thRecipe() {
  document.querySelector(".twel-meal-detail").style.display = "block"
}
function get13thRecipe() {
  document.querySelector(".thirteen-meal-detail").style.display = "block"
}
function get14thRecipe() {
  document.querySelector(".fourthteen-meal-detail").style.display = "block"
}
function get15thRecipe() {
  document.querySelector(".fivthteen-meal-detail").style.display = "block"
}
function get16thRecipe() {
  document.querySelector(".sixthteen-meal-detail").style.display = "block"
}
...
function closeBtn() {
  ...
  document.querySelector(".twel-meal-detail").style.display = "none"
  document.querySelector(".thirteen-meal-detail").style.display = "none"
  document.querySelector(".fourthteen-meal-detail").style.display = "none"
  document.querySelector(".fivthteen-meal-detail").style.display = "none"
  document.querySelector(".sixthteen-meal-detail").style.display = "none"
}
